...
impl HSBCParser {
    pub fn new(account: String, rule_sheet: PathBuf) -> HSBCParser {
        ...
        vec![
            RegexRule {
                pattern: regex::Regex::new(r"^LEADERS LTD.*$").unwrap(),
                action: RuleAction::AssignAccount("expenses:living:rent".to_string()),
            },
            RegexRule {
                pattern: regex::Regex::new(r"^Edoardo Carraro.*$").unwrap(),
                action: RuleAction::AssignAccount("income:reimbursements".to_string()),
            },
            RegexRule {
                pattern: regex::Regex::new(r"^BRITISH GAS.*$").unwrap(),
                action: RuleAction::AssignAccount("expenses:living:energy".to_string()),
            },
            RegexRule {
                pattern: regex::Regex::new(r"^WNC INCOME.*$").unwrap(),
                action: RuleAction::AssignAccount("expenses:tax:council-tax".to_string()),
            },
            RegexRule {
                pattern: regex::Regex::new(r"^.*Uber.*$").unwrap(),
                action: RuleAction::AssignAccount("expenses:transport:uber".to_string()),
            },
            RegexRule {
                pattern: regex::Regex::new(r"^.*PAYMENT CHARGE CHG$").unwrap(),
                action: RuleAction::AssignAccount("expenses:bank:transaction".to_string()),
            },
            RegexRule {
                pattern: regex::Regex::new(
                    r"^A8V5S62H RBV03036HT5POTOH.*|A8MKL477 RBV25026JE53SLA8.*$",
                )
                .unwrap(),
                action: RuleAction::AssignAccount("expenses:bank:internal-transfers".to_string()),
            },
            RegexRule {
                pattern: regex::Regex::new(r"^O2 DD$").unwrap(),
                action: RuleAction::AssignAccount("expenses:living:utilities:phone".to_string()),
            },
            RegexRule {
                pattern: regex::Regex::new(r"^SKY DIGITAL DD$").unwrap(),
                action: RuleAction::AssignAccount(
                    "expenses:lifestyle:subscriptions:sky".to_string(),
                ),
            },
            RegexRule {
                pattern: regex::Regex::new(r"^THE PEOPLE'S POSTC EDINBURGH VIS$").unwrap(),
                action: RuleAction::AssignAccount("expenses:lifestyle:entertainment".to_string()),
            },
            RegexRule {
                pattern: regex::Regex::new(r"^Non-Sterling Transaction Fee DR$").unwrap(),
                action: RuleAction::AssignAccount("expenses:bank:currency-exchange".to_string()),
            },
            RegexRule {
                pattern: regex::Regex::new(r"^ANGLIAN WATER.*$").unwrap(),
                action: RuleAction::AssignAccount("expenses:living:utilities:water".to_string()),
            },
            RegexRule {
                pattern: regex::Regex::new(r"^MERCEDES-BENZ GP L CR$").unwrap(),
                action: RuleAction::Skip,
            },
            RegexRule {
                pattern: regex::Regex::new(
                    r"^HSBC CARD PYMT DD|HSBC REWARDS538149 538149\*{6}0772 BP$",
                )
                .unwrap(),
                action: RuleAction::AssignAccount("expenses:bank:internal-transfers".to_string()),
